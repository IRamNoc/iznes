...
export class SignupComponent implements OnDestroy, OnInit {
    ...
    constructor(private ngRedux: NgRedux<any>,
        ...
        // language
        this.subscriptionsArray.push(this.requestLanguageObj
            .subscribe((requested: boolean) => this.getLanguage(requested)));
    ...
    getQueryParams() {
        this.subscriptionsArray.push(this.activatedRoute.queryParams.subscribe((params) => {
