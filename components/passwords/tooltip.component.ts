...
@Component({
    ...
    template : '<i class="fa fa-question-circle text-warning" [tooltip]="{text: passwordStrengthText, size: \'medium\'}"></i>'
})
export class PasswordTooltipComponent{
    ...
    constructor(
        ...
        <ul class="mt-1">
            ...
            <li>${this._translate.translate('One international character (e.g. Korean)')}</li>
        </ul>
        `;
    }
