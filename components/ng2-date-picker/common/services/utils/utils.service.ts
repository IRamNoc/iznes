...
export class UtilsService {
    ...
    // todo:: add unit test
    getInputType(value: any, allowMultiSelect: boolean): ECalendarValue {
    ...
    // todo:: add unit test
    // value type was CalendarValue.
    // change to  allow build for production.
    convertToMomentArray(value: any, format: string, allowMultiSelect: boolean): Array<any> {
    ...
    // todo:: add unit test
    // arr1 type was Moment[]
    // arr2 type was Moment[]
    // change type to allow build for production.
    compareMomentArrays(arr1: Array<any>, arr2: Array<any>, granularity: unitOfTime.Base): boolean {
