...
//             };
//
//             expect(service.isDateDisabled({
//                 date: moment('11-10-2016', 'DD-MM-YYYY'),
//                 selected: false
//             }, config)).toBe(true);
//             expect(service.isDateDisabled({
//                 date: moment('12-10-2016', 'DD-MM-YYYY'),
//                 selected: false
//             }, config)).toBe(false);
//             expect(service.isDateDisabled({
//                 date: moment('13-10-2016', 'DD-MM-YYYY'),
//                 selected: false
//             }, config)).toBe(false);
//             expect(service.isDateDisabled({
//                 date: moment('14-10-2016', 'DD-MM-YYYY'),
//                 selected: false
//             }, config)).toBe(false);
//             expect(service.isDateDisabled({
//                 date: moment('15-10-2016', 'DD-MM-YYYY'),
//                 selected: false
//             }, config)).toBe(true);
//
