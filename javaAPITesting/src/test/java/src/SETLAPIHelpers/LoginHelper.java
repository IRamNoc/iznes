...
public class LoginHelper {
  ...
  public static Connection login(SocketClientEndpoint socket, String address, Consumer<org.json.simple.JSONObject> callback) {
  ...
  public static void command(SocketClientEndpoint socket, Message msg, Consumer<org.json.simple.JSONObject> callback) {
