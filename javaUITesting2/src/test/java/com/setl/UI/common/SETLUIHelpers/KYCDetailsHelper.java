...
public class KYCDetailsHelper extends LoginAndNavigationHelper {
    ...
    public static void KYCProcessStep1(String managementCompanyEntered) throws SQLException, InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
    ...
    public static void KYCProcessRequestListValidation(String modalTitles, String managementCompanyEntered, String expectedStatus) throws SQLException, InterruptedException, IOException {
        WebDriverWait wait = new WebDriverWait(driver, timeoutInSeconds);
