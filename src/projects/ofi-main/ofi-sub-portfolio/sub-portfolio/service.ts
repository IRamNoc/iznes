...
export class OfiSubPortfolioService {
    ...
    getSubPortfolioFormValue(values, bankIdentificationStatement) {
        return {
            ...
            custodianPayment: _.get(values.custodianPayment, [0, 'id'], values.custodianPayment),
            custodianPosition: _.get(values.custodianPosition, [0, 'id'], values.custodianPosition),
            custodianTransactionNotices: _.get(values.custodianTransactionNotices, [0, 'id'], values.custodianTransactionNotices),
