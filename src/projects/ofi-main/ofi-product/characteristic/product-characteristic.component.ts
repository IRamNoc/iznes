    ...
    ngOnInit() {
        ...
        .subscribe(([c, p]) => {
            ...
            this.currentProduct = {
                ...
                subscriptionQuantityRoundingRule: SubscriptionCategoryEnum[d.subscriptionQuantityRoundingRule],
                redemptionSettlementPeriod,
                navPeriodForRedemption,
                redemptionCategory: SubscriptionCategoryEnum[d.redemptionCategory],
                redemptionQuantityRoundingRule: SubscriptionCategoryEnum[d.subscriptionQuantityRoundingRule],
