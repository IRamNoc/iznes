...
function handleSetFundAccessMy(state: OfiFundAccessMyState, action: Action): OfiFundAccessMyState {
    ...
    const accessDataList = accessDataImu.reduce((result, item) => {
        ...
        result.fundShareAccessList[shareId] = {
            ...
            subscriptionFeeInFavourOfFund: item.get('subscriptionFeeInFavourOfFund', 0),
            subscriptionFeeInFavourOfFundCalculation: item.get('subscriptionFeeInFavourOfFundCalculation', 0),
            redemptionFeeInFavourOfFund: item.get('redemptionFeeInFavourOfFund', 0),
            redemptionFeeInFavourOfFundCalculation: item.get('redemptionFeeInFavourOfFundCalculation', 0),
