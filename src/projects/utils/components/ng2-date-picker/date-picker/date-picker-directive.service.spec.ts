...
//     });
//
//     xit('should check convertToElement method', inject([DatePickerDirectiveService, UtilsService],
...
//         }));
//
//     xit('should check getConfig method', inject([DatePickerDirectiveService],
