...
function handleGetIznesFunds(state: FundListState, action: Action): any {
    ...
    const iznFundList = data.reduce((sum, fund) => {
        const fundData: IznesFundDetail = {
            ...
            fundCurrency: fund.fundCurrency !== null ? fund.fundCurrency.toString() : null,
            ...
            fundAdministrator: fund.fundAdministrator !== null ? fund.fundAdministrator.toString() : null,
            custodianBank: fund.custodianBank !== null ? fund.custodianBank.toString() : null,
            ...
            portfolioCurrencyHedge: fund.portfolioCurrencyHedge !== null ? fund.portfolioCurrencyHedge.toString() : null,
