...
export class SetlMyAccountComponent implements OnDestroy, OnInit {
            ...
            SagaHelper.runAsync(
                ...
                (data) => {
                    ...
                    this.alertsService.generate(
                        'success',
                        this.translate.translate('Your password has been successfully changed.'),
                    );
                ...
                (data) => {
                    ...
                    this.alertsService.generate(
                        'error',
                        this.translate.translate('Password could not be changed. Please check and try again.'),
                    );
                }, // fail
            ),
        );
    ...
    submitDetails(formValues) {
        ...
        this.ngRedux.dispatch(SagaHelper.runAsyncCallback(
            ...
            (data) => {
                this.alertsService.generate(
                    'success',
                    this.translate.translate('User details have been successfully updated.'),
                );
    ...
    setCountries() {
        this.countries = this.translate.translate([
